                ...
                <div class="row">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Register WiFi</h3>
                        </div>
                        <div class="panel-body">
                            <form method="post" action="RegisterWifiServlet" class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-3" for="wifiid">WiFi ID</label>
                                    <div class="col-md-3">
                                        <input type="text" id="wifiid" name="wifiid" class="form-control" />
                                    </div>
                                </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <%
                                ...
                                List<String[]> wifis = DBUtils.getWifis();

                                for (String[] wifi : wifis) {
                            %>
                            <tr>
                                <% for (String wifi1 : wifi) {
                                ...
                                %>
                                <td><a href="deletewifi.jsp?id=<%= wifi[0] %>" class="btn btn-danger">delete</a></td>
                            </tr>
                            <%
                                }
                            %>
