    ...
    <body>
        ...
        <%
            ...
            for(String[] permission : permissions){
                if(permission[0].equals(id)){
                    userPermission = permission;
                    break;
                }
            }
            
            String[] userData = DBUtils.getUserbyId(userPermission[0]);
        %>
                    ...
                    <div class="row">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="col-md-6">
                                    <form method="post" action="UpdatePermissionServlet" class="form-horizontal">
                                        <input type="hidden" name="permissionid" value="<%= userPermission[0] %>" />
                                        <div class="form-group">
                                            <label class="col-md-6" for="username">Select User</label>
                                            <div class="col-md-6">
                                                <input type="text" id="username" name="username" class="form-control" value="<%= userPermission[1] %>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="time" name="time" class="form-control" value="<%= userPermission[6] %>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="latitude" id="latitude" value="<%= userPermission[7] %>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-6" for="longitude">Longitude</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="longitude" id="longitude" value="<%= userPermission[8] %>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
