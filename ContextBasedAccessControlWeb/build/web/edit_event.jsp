                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="col-md-6">
                                    ...
                                    <%
                                        String[] thisEvent = new String[]{};
                                        DBUtils.connect();
                                        List<String[]> events = DBUtils.getEvents();
                                        
                                        for(String[] event : events){
                                            if(event[5].equals(request.getParameter("id"))){
                                                thisEvent = event;
                                                break;
                                            }
                                        } 
                                    ...
                                    <form method="post" action="UpdateEvent" class="form-horizontal">
                                        <div class="form-group">
                                            <label class="col-md-6" for="event">Event</label>
                                            <div class="col-md-6">
                                                <input type="text" id="event" name="event" class="form-control" value="<%= thisEvent[0] %>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <textarea id="details" name="details" class="form-control"><%= thisEvent[1] %></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="date" name="date" class="form-control" value="<%= thisEvent[2] %>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="time" name="time" class="form-control" value="<%= thisEvent[3] %>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="location" name="location" class="form-control" value="<%= thisEvent[4] %>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="latitude" id="latitude" value="<%= thisEvent[6] %>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-6" for="longitude">Longitude</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="longitude" id="longitude" value="<%= thisEvent[7] %>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
